...
const SidebarTrigger = /*#__PURE__*/ _s3((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(_c4 = _s3(({ className, onClick, children, ...props }, ref)=>{
    _s3();
...
const SidebarMenuSkeleton = /*#__PURE__*/ _s6((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(_c38 = _s6(({ className, showIcon = false, ...props }, ref)=>{
    _s6();
    const [width, setWidth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('75%');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
}, "rbzbOHz26lE9c7igVYvbH09/78I=")), "rbzbOHz26lE9c7igVYvbH09/78I=");
...
if ("TURBOPACK compile-time truthy", 1) {
    ...
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enableNetwork"])(db);
        // Add connection state monitoring
        const handleConnectionChange = ()=>{
            if (navigator.onLine) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enableNetwork"])(db).catch(console.warn);
            } else {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["disableNetwork"])(db).catch(console.warn);
            }
        };
...
__turbopack_context__.s({
    ...
    "getMockUsersByRole": (()=>getMockUsersByRole),
...
const mockUsers = [
    ...
    // Suppliers
    {
        ...
        rating: 4.8,
        online: true,
        description: '一家领先的创新电子元件制造商，拥有超过十年的历史。'
    },
    {
        id: 'supplier-2',
        name: '快速原型公司',
        email: 'info@rapid-proto.com',
        role: 'supplier',
        specialty: 'SLA & FDM 打印',
        status: '正常',
        rating: 4.5,
        online: false,
        description: '提供快速、可靠的原型制作服务。'
    },
    // Creators
    {
        id: 'creator-1',
        ...
        role: 'creator',
        specialty: '奇幻与科幻角色设计',
        description: '10年以上角色设计经验，专精于奇幻与科幻风格。',
        tags: [
            '3D角色',
            '科幻',
            '风格化'
    ...
    },
    {
        ...
        role: 'creator',
        specialty: '动态图形与抽象3D艺术',
        description: '动态图形与抽象3D艺术专家。',
        tags: [
            '抽象',
            'Houdini',
            '动态设计'
...
async function getUserById(userId) {
    try {
        ...
        console.warn("Firestore unavailable, searching mock data:", error);
        // 在模拟数据中查找用户
...
const useAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set)=>({
        ...
        loginWithMock: async (userId)=>{
            ...
            if (mockUser) {
                ...
                console.log(`Mock login successful for user: ${mockUser.name}`);
            } else {
                console.error("Mock login failed: User not found in mock data.");
                set({
                    role: null,
                    user: null
                });
...
function AppLayout({ children }) {
    ...
    const { role, user, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppLayout.useEffect": ()=>{
            setMounted(true);
        }
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Sidebar"], {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SidebarHeader"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex items-center gap-2 p-2 justify-center group-data-[collapsible=icon]:justify-center",
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    className: "text-xl font-bold font-headline group-data-[collapsible=icon]:hidden",
                                    children: "AI 智能匹配"
                                }, void 0, false, {
                                    fileName: "[project]/src/components/app-layout.tsx",
                                    lineNumber: 116,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SidebarInset"], {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                        className: "sticky top-0 z-10 flex h-14 items-center gap-4 border-b bg-background/80 backdrop-blur-sm px-4 md:hidden",
                        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                        className: "flex-1 overflow-auto p-4 sm:px-6 sm:py-6",
                        children: children
                    }, void 0, false, {
                        fileName: "[project]/src/components/app-layout.tsx",
                        lineNumber: 168,
...
_s(AppLayout, "GJ4qwchozh1UPFfDqK4HIXRYcpQ=", false, function() {
    return [
...
//# sourceMappingURL=src_25251ca9._.js.map