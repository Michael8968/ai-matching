...
"[project]/src/app/permissions/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PermissionsPage() {
    ...
    const fetchUsers = async ()=>{
        setIsLoading(true);
        try {
            const fetchedUsers = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUsers"])();
    ...
    const handleSaveChanges = async (userId)=>{
        ...
        if (!changes) return;
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUser"])(userId, changes);
            toast({
                title: "成功",
                description: "用户数据已更新。"
            });
    ...
    const handleUpdateStatus = async (userId, status)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUser"])(userId, {
                status
            });
            setUsers(users.map((u)=>u.id === userId ? {
                    ...u,
    ...
    const handleDeleteUser = async (userId)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteUser"])(userId);
...
_s(PermissionsPage, "oVuGlwKrsaBMRbLo0FSYpb405p4=", false, function() {
    return [
...
//# sourceMappingURL=src_755b4c1b._.js.map